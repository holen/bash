...
sed -i 's/Server=.*/Server=10.0.120.11/g' $CONF
#sed -i 's/Server=.*/Server=10.10.10.105/g' $CONF
#sed -i 's/ServerActive=.*/ServerActive=10.10.10.105/g' $CONF
sed -i 's/ServerActive=.*/ServerActive=10.0.120.11/g' $CONF
